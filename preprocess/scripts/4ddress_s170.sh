...
python train_mesh_lbs_4ddress.py \
    ...
    --labels 3 4 \
    --data_path ${DATADIR}/4D-DRESS/00${SUBJECT}/Inner/Take${TAKE} \
    --wandb \
...
python lbs_weights_inpainting_4ddress.py \
    --smplx_gender ${GENDER} \
    --src_mesh_path ${DATADIR}/4D-DRESS/00${SUBJECT}/Inner/Take${TAKE}/SMPLX/mesh-f000${START_IDX}_smplx.ply \
    --src_param_path ${DATADIR}/4D-DRESS/00${SUBJECT}/Inner/Take${TAKE}/SMPLX/mesh-f000${START_IDX}_smplx.pkl \
